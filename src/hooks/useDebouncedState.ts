 ...
 * Ex: if user is typing in search box, we don't want the value to update until they've stopped typing for more than X ms
 * Usage:
 * * const [example, setExample] = useState<string>('');
 * * const debouncedExample = useDebouncedState(example, 1000);
 */
